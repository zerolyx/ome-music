  ...
  return (
    <section className="now-playing-stage relative mx-auto grid w-full max-w-[1780px] items-center overflow-visible">
      ...
      >
        ...
        {isLyricsLoading ? (
          <div className="flex h-[58vh] items-center text-3xl font-black text-[#4a2108]/45">
          ...
          <div className="flex h-[58vh] flex-col justify-center">
            <p className="max-w-[760px] text-balance text-3xl font-black leading-snug text-[#4a2108]/60 xl:text-5xl">
              Let the room breathe for a moment.
            </p>
            {lyricWarning && (
              <p className="mt-5 max-w-md text-sm font-semibold text-[#4a2108]/45">
                {lyricWarning}
              </p>
            )}
          </div>
