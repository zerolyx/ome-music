      ...
      >
        ...
        <div className="mt-6 w-[min(70vw,390px)] text-center md:w-[min(29vw,420px)] md:text-left">
          ...
          >
            <h1
              title={track.title}
              className="line-clamp-2 max-h-[2.12em] text-[clamp(1.18rem,1.65vw,1.72rem)] font-bold leading-[1.06] text-[#4a2108]/88 transition-opacity duration-300 hover:opacity-70"
            >
              {track.title}
            </h1>
          </div>
